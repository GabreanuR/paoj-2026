            ...
            try {
                switch (option) {
                    ...
                    case "2":
                        ...
                        String availableSubjects = java.util.Arrays.toString(Subject.values()).replaceAll("[\\[\\]]", "");
                    ...
                    case "5":
                        java.util.Map<Subject, Double> averages = service.getAveragePerSubject();
                        if (averages.isEmpty()) {
                            System.out.println("Nu există nicio notă înregistrată în sistem.");
                        } else {
                            System.out.println("Media pe materii");
                            for (java.util.Map.Entry<Subject, Double> entry : averages.entrySet()) {
