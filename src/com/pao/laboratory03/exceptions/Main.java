...
public class Main {
    public static void main(String[] args) {
        System.out.println("a) UNCHECKED EXCEPTIONS");
        try {
            riskyMethod();
        ...
        try {
            ...
            System.out.println("Excepție generală: " + e.getMessage());
        }
    ...
    static void riskyMethod() {
        throw new NullPointerException("Cannot invoke \"String.length()\" because \"s\" is null");
    }
