...
import com.pao.laboratory03.exception.InvalidGradeException;
import com.pao.laboratory03.exception.InvalidStudentException;
...
public class Student {
    ...
    public void addGrade(Subject subject, double grade) {
        if (grade < 1 || grade > 10) {
            throw new InvalidGradeException("Nota trebuie să fie cuprinsă între 1 și 10.");
        }
