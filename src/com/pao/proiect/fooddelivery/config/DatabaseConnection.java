package com.pao.proiect.fooddelivery.config;
...
public final class DatabaseConnection {
    ...
    private DatabaseConnection() throws IOException, SQLException {
        ...
        try (InputStream is = getClass().getClassLoader().getResourceAsStream("com/pao/proiect/fooddelivery/resources/db.properties")) {
            if (is == null) {
